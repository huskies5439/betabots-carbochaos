...
public class Trajet2cubes extends SequentialCommandGroup {


  public Trajet2cubes(BasePilotable basePilotable, Poussoir poussoir) {

    Trajectory trajet = basePilotable.creerTrajectoire("2cubes");
